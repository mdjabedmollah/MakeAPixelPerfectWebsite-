      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <ul className="hidden md:flex items-center gap-8 text-gray-600">
            ...
            <li className="cursor-pointer hover:text-black"> <NavLink to="/my-bookings">My-Bookings</NavLink></li>
            <li className="cursor-pointer hover:text-black">  <NavLink to="/blogs">Blogs</NavLink></li>
          
            <li className="cursor-pointer hover:text-black"> <NavLink to="/contact">Contact Us</NavLink> </li>
          </ul>
          <div>
